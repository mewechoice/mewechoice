...
const a=fact("a","FINANCING_PROJECTED_OUTLAY",100),b=fact("b","FINANCING_PROJECTED_OUTLAY",120),cc=cr.buildComparisonClaim(a,b,{temporalBasis:"same-term",valueNature:"PROJECTED_OUTLAY",completenessCompatibility:true,modeledComponents:["principal"],unmodeledComponents:[]});
